    ...
    <div className="business-card">
      ...
      <div className="business-card-body">
        <div className="business-info">
          <span className="info-label">מקצוע:</span>
          <span className="business-field-emphasized">
            {business.fieldOfWork}
          </span>
        </div>
        <div className="business-info">
          <div className="phone-actions">
            <a
              ...
              className="phone-icon phone-call"
              title="התקשר"
              aria-label="התקשר"
            >
              <svg
            ...
            <a
              href={`https://wa.me/972${business.phone.replace(/[^0-9]/g, "")}`}
              className="phone-icon whatsapp"
              target="_blank"
        ...
        {business.city && (
          <div className="business-info">
            ...
            <span className="business-city">{business.city}</span>
          </div>
        )}
        {business.notes && (
